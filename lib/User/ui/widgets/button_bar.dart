...
import 'package:my_trips_flutter_app/Place/ui/screens/add_place_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
        ...
        child: Row(
          children: <Widget>[
            //Cambiar contraseña
            CircleButton(true, Icons.vpn_key_outlined, 20.0, Color.fromRGBO(255, 255, 255, 0.6), () => {}),
